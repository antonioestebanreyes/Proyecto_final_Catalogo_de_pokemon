...
const descri = () => {
  for (let index = 0; index < pokemon_name1.length; index++) {
    ...
    for (let i = 0; i < pokemon_altura1.length; i++) {
      ...
      if (
        element_name.toUpperCase() === datos_de_busquedad.value.toUpperCase() &&
        i === index
      ) {
        const ol = document.createElement("ol");
        ...
        for (let peso = 0; peso < pokemon_peso1.length; peso++) {
          ...
          if (
            element_name.toUpperCase() ===
              datos_de_busquedad.value.toUpperCase() &&
            peso === index
          ) {
            const ol = document.createElement("ol");
            descripcion.appendChild(ol);
        ...
        for (
          let categoria = 0;
          categoria < pokemon_categoria1.length;
          categoria++
        ) {
...
window.onscroll = function() {
  ...
  if (y>=25) {
   cabeza.style.visibility="hidden"
    ...
    cabeza.style.visibility="visible"
